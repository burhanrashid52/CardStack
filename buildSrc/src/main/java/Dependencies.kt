...
object Versions {
    ...
    internal var kotlin_version = "1.2.41"
    ...
    internal var gradle_plugin_version = "3.1.3"
    ...
    internal const val play_service_version = "17.0.0"
    internal const val navigation_version = "1.0.0-alpha02"

}

object PluginsDeps {
    var gradle_plugin = "com.android.tools.build:gradle:${Versions.gradle_plugin_version}"
    var google_service_plugin = "com.google.gms:google-services:3.2.0"
    var navigation_plugin = "android.arch.navigation:navigation-safe-args-gradle-plugin:${Versions.navigation_version}"


}

object KotlinDeps {
    var kotlin_std_lib = "org.jetbrains.kotlin:kotlin-stdlib-jdk7:${Versions.kotlin_version}"
    ...
    var android_ktx = "androidx.core:core-ktx:0.3"
}
...
object OtherDeps {
    ...
    var multidex = "com.android.support:multidex:1.0.3"
    var rippleAnimation = "com.skyfishjy.ripplebackground:library:1.0.1"
    var shapeImageView = "com.github.siyamed:android-shape-imageview:0.9.+@aar"
}
...
object ArchComponents {
    ...
    val navigatinFragment = "android.arch.navigation:navigation-fragment-ktx:${Versions.navigation_version}"
    val navigatinUI = "android.arch.navigation:navigation-ui-ktx:${Versions.navigation_version}"

}

object FirebaseDeps {
    val fcm = "com.google.firebase:firebase-messaging:${Versions.play_service_version}"
}